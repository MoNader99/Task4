...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        item = self.SongsTable.item(0, 0)
        item.setText(_translate("MainWindow", "wegz"))
        item = self.SongsTable.item(0, 1)
        item.setText(_translate("MainWindow", "100%"))
        item = self.SongsTable.item(1, 0)
        item.setText(_translate("MainWindow", "godzilla"))
        item = self.SongsTable.item(1, 1)
